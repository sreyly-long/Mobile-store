        ...
        <>
            <footer class="py-3 my-4">
                <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                    ...
                    <li class="nav-item"><Link to="/talet" class="nav-link px-2 text-body-secondary">Tablet</Link></li>
                    <li class="nav-item"><Link to="/lapto" class="nav-link px-2 text-body-secondary">Laptop</Link></li>
